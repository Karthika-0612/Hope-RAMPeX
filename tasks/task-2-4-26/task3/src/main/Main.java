...
public class Main {
    public static void main(String[] args) {
        ...
        Notification email = NotificationFactory.createNotification( "email", user1, "Welcome to our platform!");
        service.sendNotification(email);
        Notification sms = NotificationFactory.createNotification("sms", user1, "Your OTP is 1234");
